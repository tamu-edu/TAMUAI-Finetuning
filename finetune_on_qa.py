"""
title: Supervised (QA) Finetuning
...
import logging
import sys
from training_core.sl_training_core import train_qa_model
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('finetune_qa.log'),
...
def main():
    try:
        parser = argparse.ArgumentParser(description='LLM supervised finetuning script')
